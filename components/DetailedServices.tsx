...
const SERVICE_IMAGES: Record<string, string> = {
  ...
  'part-loads': '/britons-removals-storage-derby-2.png',
  'packing': 'https://images.unsplash.com/photo-1520038410233-7141be7e6f97?q=80&w=1200&auto=format&fit=crop',
  'storage': 'https://images.unsplash.com/photo-1595246140625-573b715d11dc?q=80&w=1200&auto=format&fit=crop',
};
    ...
    <section id="services" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <span className="text-blue-600 font-bold tracking-widest uppercase text-sm">European Household Removals</span>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mt-3 mb-6">Practical, professional removals between the UK and Europe</h2>
          <p className="text-slate-600 max-w-3xl mx-auto text-lg leading-relaxed">
            We move households to and from Spain, France, Germany, Italy and destinations across Europe. Whether you are relocating a full family home, sending a smaller part load, need export packing, or need storage while dates are being finalised, we focus on careful handling, clear planning and dependable delivery.
          </p>
        </div>
            ...
            >
              <div className="flex-1 space-y-6">
                ...
                <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-blue-600 mt-8">
                  <h4 className="font-bold text-slate-900 mb-2">How we handle it:</h4>
                ...
                <button className="inline-flex items-center text-blue-600 font-bold hover:translate-x-2 transition-transform mt-4">
                  Plan your move with us <ArrowRight size={18} className="ml-2" />
                </button>
              </div>
              ...
              <div className="flex-1 bg-slate-100 rounded-3xl overflow-hidden aspect-video shadow-2xl relative group">
                <img
                  ...
                  alt={SERVICE_IMAGE_ALTS[service.id]}
